function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://www.airtel-vodafone.je";
	this.homepageUrl = "http://www.airtel-vodafone.com";
	this.message_centre_number = "+447829791004";
	this.method = "";
	this.my_account_url = "http://www.airtel-vodafone.com";
	this.my_account_registration = "http://www.airtel-vodafone.com";
	this.operator = "Airtel-Vodafone";
	...
	this.supportUrl = "www.airtel-vodafone.je";
	this.ThreeG = "3G";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
