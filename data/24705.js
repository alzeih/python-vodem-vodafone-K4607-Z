function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://www.bite.lv/lv/node/905";
	this.homepageUrl = "http://www.bite.lv";
	this.message_centre_number = "+37125850115";
	this.method = "";
	this.my_account_url = "http://manabite.lv";
	this.my_account_registration = "http://manabite.lv";
	this.operator = "Bite Latvija";
	this.partner_branding = "Partner";
	this.partnerLogo = "Banner24705.png";
	this.password = "";
	this.check_balance_method = "";
	this.prepay = { check : "", topup : "" , online : "http://manabite.lv "};
	...
	this.supportUrl = "http://www.bite.lv/lv/node/905";
	this.ThreeG = "3G";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
