function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://www.elisa.fi/tuki/mobiililaajakaista";
	this.homepageUrl = "http://www.elisa.fi";
	this.message_centre_number = "+358508771010";
	this.method = "";
	this.my_account_url = "https://oma.elisa.fi";
	this.my_account_registration = "https://oma.elisa.fi";
	this.operator = "Elisa";
	this.partner_branding = "Partner";
	this.partnerLogo = "Banner24405.png";
	this.password = "";
	...
	this.supportUrl = "http://www.elisa.fi/tuki/mobiililaajakaista";
	this.ThreeG = "3G";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
