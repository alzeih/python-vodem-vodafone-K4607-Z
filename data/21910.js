function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://vmc.vipnet.hr";
	this.homepageUrl = "http://www.vipnet.hr";
	this.message_centre_number = "+385910401";
	this.method = "";
	this.my_account_url = "http://moj.vip.hr";
	this.my_account_registration = "http://moj.vip.hr";
	this.operator = "Vipnet";
	this.partner_branding = "Partner";
	this.partnerLogo = "Banner21910.png";
	this.password = "";
	this.check_balance_method = "";
	this.prepay = { check : "", topup : "" , online : "http://moj.vip.hr"};
	...
	this.supportUrl = "http://vmc.vipnet.hr";
	this.ThreeG = "UMTS";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
