function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://www.vodafone.is/hjalp/3gnet";
	this.homepageUrl = "http://www.vodafone.is";
	this.message_centre_number = "+3546999099";
	this.method = "";
	this.my_account_url = "http://www.vodafone.is/minar";
	this.my_account_registration = "http://www.vodafone.is/minar/nyskra";
	this.operator = "Vodafone Iceland";
	this.partner_branding = "No";
	this.partnerLogo = "";
	this.password = "";
	this.check_balance_method = "";
	this.prepay = { check : "", topup : "" , online : "http://www.vodafone.is/3gnet/afylling"};
	...
	this.supportUrl = "http://www.vodafone.is/hjalp/3gnet";
	this.ThreeG = "3G";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
