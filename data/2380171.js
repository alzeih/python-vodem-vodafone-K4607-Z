function opcoObject() {
	...
	this.dns1 = "";
	this.dns2 = "";
	this.help_url = "http://www.tdc.no";
	this.homepageUrl = "http://www.tdc.no";
	this.message_centre_number = "+4540390966";
	this.method = "";
	this.my_account_url = "http://www.tdc.no";
	this.my_account_registration = "http://www.tdc.no";
	this.operator = "TDC Norway";
	this.partner_branding = "Partner";
	this.partnerLogo = "Banner2380171.png";
	this.password = "";
	...
	this.supportUrl = "http://www.tdc.no";
	this.ThreeG = "3G";
	this.GSM = "GSM";
	this.TwoG = "GPRS";
	this.edge = "EDGE";
