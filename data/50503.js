function opcoObject() {
	...
	if (this.account_type === "Contract" && this.apn === "vfinternet.au") {
		...
		this.dns1 = "";
		this.dns2 = "";
		this.help_url = "http://www.vodafone.com.au/help";
		this.homepageUrl = "http://www.vodafone.com.au";
		this.message_centre_number = "+61415011501";
		this.method = "";
		this.my_account_url = "http://broadband.vodafone.com.au/manage";
		this.my_account_registration = "http://myvodafone.com.au ";
		this.operator = "Vodafone Australia";
		...
		this.supportUrl = "http://www.vodafone.com.au/help";
		this.ThreeG = "3G";
		this.GSM = "GSM";
		this.TwoG = "GPRS";
		this.edge = "EDGE";
		...
		this.password = "web";
		this.check_balance_method = "";
		this.prepay = { check : "", topup : "" , online : "http://broadband.vodafone.com.au/manage"};
		this.check_balance_SMS_MSG = "";
		this.top_up_by_voucher = "disabled";
		this.balance_check_replace = "";
		this.balance_check_with = "";
