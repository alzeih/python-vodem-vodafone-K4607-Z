function opcoObject() {
	...
	if (this.account_type === "Contract" && this.apn === "Dialogbb") {
		this.country = "Sri Lanka";
		this.currency = "";
		this.data_notification = "";
		this.dns1 = "";
		this.dns2 = "";
		this.help_url = "www.business.vodafone.com";
		this.homepageUrl = "http://www.dialog.lk";
		this.message_centre_number = "+9477000003";
		this.method = "";
		this.my_account_url = "http://login.dialog.lk";
		this.my_account_registration = "http://login.dialog.lk";
		this.operator = "DIALOG";
		this.partner_branding = "Partner";
		this.partnerLogo = "Banner41302.png";
		this.password = "";
		...
		this.supportUrl = "www.business.vodafone.com";
		this.ThreeG = "3G";
		this.GSM = "GSM";
		this.TwoG = "GPRS";
		this.edge = "EDGE";
