function opcoObject() {
	...
	this.homepageUrl = "http://www.celcom.com.my";
	this.message_centre_number = "+60193900000";
	this.method = "";
	this.my_account_url = "http://www.celcom.com.my";
	this.my_account_registration = "http://www.celcom.com.my";
	this.operator = "Celcom Malaysia";
	this.partner_branding = "Partner";
	this.partnerLogo = "Banner50219.png";
	this.password = "";
